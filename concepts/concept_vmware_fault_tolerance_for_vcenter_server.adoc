...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability/providing-fault-tolerance-for-virtual-machines/fault-tolerance-requirements-limits-and-licensing.html["Documentación de VMware vSphere: Requisitos, límites y licencias de Fault Tolerance"]

...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-resource-management.html["Documentación de VMware vSphere: Habilitar Storage I/o Control"^]

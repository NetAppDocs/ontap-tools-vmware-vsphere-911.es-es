...
[role="lead"]
Puede realizar una actualización en el lugar a la última versión de las herramientas de ONTAP desde su versión 9.10 o posterior existente siguiendo las instrucciones que se proporcionan aquí.
